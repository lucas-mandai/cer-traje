export const features = [
  {
    id: "0",
    icon: "/images/pescoco.png",
    caption: "Uma nova era chegou",
    title: "Performance e Reabilitação",
    text: "Potencialize seus resultados utlizando eletroestimulação (EMS) totalmente sem fio, podendo ser utilizado desde em atletas profissionais até em pessoas com idade avançada",
    button: {
  ...
  },
  {
    ...
    title: "Adaptação Perfeita ao corpo",
    text: "Nosso traje simplifica o processo de treino proporcionando uma experiência eficaz e confortável permitindo grande liberdade de movimento durante os exercícios, graças ao seu design ultraleve, flexível e resistente",
    button: {
      icon: "/images/play.png",
      title: "Preview",
    },
...
export const details = [
  ...
  {
    id: "1",
    icon: "/images/seguranca.png",
    title: "Seguro e Efetivo",
  },
  {
    id: "2",
    icon: "/images/coracao.png",
    title: "Redução de gordura e celulites",
  },
  {
    id: "3",
...
export const faq = [
  {
    id: "0",
    question: "Qual o tempo de treino?",
    answer:
      "O tempo de treino com o traje é de aproximadamente 20 minutos",
  },
  {
    id: "1",
    question: "Em quanto tempo consigo visualizar resultados?",
    answer:
      "De 4 a 6 sessões já conseguirá visualizar resultados",
  },
  {
    id: "2",
  ...
  {
    id: "3",
    question: "Qual o tempo para atingir o limiar aeróbico?",
    answer:
      "De 6 a 10 minutos",
  },
  {
    id: "4",
    question: "O que devo trazer comigo para o treino?",
    answer:
      "É necessário utilizar apenas roupas íntimas por baixo do colete para melhor abtenção dos resultados. Além disso, é importante tomar água para hidatação, assim como uma toalha, já que os exercícios farão você suar",
  },
  {
    id: "5",
    question: "É possível modificar a intensidade dos impulsos durante o treinamento?",
    answer:
      "Sim. Essa é uma função muito importante que possibilita que sejam ajustados os níveis apropriados durante o treinamento, de acordo com as habilidades e estado físico do usuário. Se o exercício não estiver suficientemente exaustivo, é possível aumentar a intensidade dos impulsos, assim como, se o exercício estiver muito forte é possível reduzir a intensidade a qualquer momento.",
  },
  {
    id: "6",
    question: "Pode ser utilizado para reabilitação?",
    answer:
      "Sim. Nosso traje é uma ferramenta ideal para reabilitação de alguns tipos de lesões, porque os impulsos elétricos não sobrecarregam as juntas. Os estimuladores musculares elétricos já vêm sendo utilizados a algum tempo em aplicações médicas.",
  },
  {
    id: "7",
    question: "Qual a diferença desse para outros sistemas de estimulação muscular?",
    answer:
      "Ao contrário de outros estimuladores, seus eletrodos conduzem eletricidade por toda sua superfície, logo os impulsos permitem um trabalho muscular mais intenso. O traje do sistema se acomoda perfeitamente ao corpo, além de ser totalmente seco e sem fio",
  },
  {
    id: "8",
  ...
  },
  {
    ...
    answer:
      "Não é recomendado que mulheres grávidas e quem usa marcapasso cardíaco façam o treinamento. Entretanto, pode ser uma ótima opção para reabilitação e recuperação do corpo da mulher após o nascimento da criança",
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 400,
    priceYearly: 750,
    caption: "Ideal para experimentar",
    features: [
      // "100MB Cloud storage",
...
export const socials = [
  {
    ...
    url: "https://www.instagram.com/cerfisioterapialins/",
  },
  {
    id: "1",
    title: "Discord",
    icon: "/images/facebook.png",
    url: "https://www.facebook.com/cerfisioterapialins",
  },
];
